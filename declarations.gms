...
PARAMETER
    ...
    GH0			Initial Government Health Spending
    GE0			Initial Government Education Spending
    ...
    DH(g)		Distribution of Health spending
    DE(g)		Distribution of Education spending
;
...
PARAMETER
    ...
    Pens0(q,e,g)	Initial Pension
    CTR0		Initial Contribution Rate
    PensR		Pension Rate
;
...
PARAMETER
    ...
    GovH(t)		Health Spending
    GovE(t)		Education Spending
    YCap(s,t)		GDP per Capita
;
...
VARIABLE
    ...
    Pens(q,e,t,g)	Pension
    CTR(t)		Contribution Rate
;
